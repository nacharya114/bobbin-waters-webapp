...
angular.module('gservice', ['reportService'])
    .factory('gservice', function($rootScope, $http, reportService){
        ...
        var Location = function(latlon, message, username, date, type, cond, virus, chem){
            this.latlon = latlon;
        ...
        var initialize = function(latitude, longitude, filter) {
           ...
           var initializeEmpty = function(latitude, longitude, filter) {
